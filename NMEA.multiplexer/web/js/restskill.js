        ...
        for (var i=0; i<json.length; i++) {
          ...
          switch (type) {
              ...
              case 'htu21df':
                  ...
                  break;
              default:
                html += ("<tr><td><b>" + type + "</b></td><td></td><td></td><td align='center'></td><td></td></tr>");
                break;
          }
        }
        html += "</table>";
        ...
        for (var i=0; i<json.length; i++) {
            ...
            switch (type) {
                case 'tw-current':
                    ...
                    break;
                default:
                    html += ("<tr><td valign='top'><b>" + type + "</b></td><td valign='top'></td><td valign='top' align='center'></td><td valign='top'></td></tr>");
                    break;
            }
        }
        html += "</table>";
