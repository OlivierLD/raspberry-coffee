...
public class SerialCommArduino implements SerialIOCallbacks {
	...
	public static void main(String[] args) {
		final SerialCommArduino mwc = new SerialCommArduino();
		...
		String baudRateStr = System.getProperty("baud.rate", "115200");
