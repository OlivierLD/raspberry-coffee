...
process.title = 'node-level-detector';
...
//    console.log((new Date()) + ' Received Message: ' + message.utf8Data);
      try
      {
        ...
        // Reply to sender
        var reply = {
          ack: 'Your message has been received',
          mess: userMess
        };
      ...
      // broadcast message to all connected clients (EXCEPT the sender). That's what this app is doing.
