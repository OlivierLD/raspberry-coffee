...
public class L3GD20Dictionaries {
	...
	public final static Map<String, Byte> EnabledMap = new HashMap<>();
	...
	public final static Map<String, Byte> LevelMap = new HashMap<>();
	...
	public final static Map<String, Byte> OutputMap = new HashMap<>();
	...
	public final static Map<String, Byte> SimModeMap = new HashMap<>();
	...
	public final static Map<String, Byte> BigLittleEndianMap = new HashMap<>();
	...
	public final static Map<String, Byte> FullScaleMap = new HashMap<>();
	...
	public final static String CONTINUOUS_UPDATE = "Continuous update";
	public final static String NOT_UPDATED_UNTIL_READING = "Output registers not updated until reading";
	public final static Map<String, Byte> BlockDataUpdateMap = new HashMap<>();
	...
	public final static Map<String, Byte> OutSelMap = new HashMap<>();
	...
	public final static Map<String, Byte> IntSelMap = new HashMap<>();
	...
	public final static Map<String, Byte> BootModeMap = new HashMap<>();
	...
	public final static Map<String, Byte> FifoModeMap = new HashMap<>();
	...
	public final static Map<String, Byte> AndOrMap = new HashMap<>();
	...
	public final static Map<String, Byte> HighPassFilterMap = new HashMap<>();
	...
	// __DRBW
	public final static Map<Integer, Map<Float, Byte>> DataRateBandWidthMap = new HashMap<>();

	static {
		// DataRateValues[0] : { BandWidthValues[0]:0x00, BandWidthValues[2]:0x01},
		Map<Float, Byte> map0 = new HashMap<>();
		...
		Map<Float, Byte> map1 = new HashMap<>();
		...
		Map<Float, Byte> map2 = new HashMap<>();
		...
		Map<Float, Byte> map3 = new HashMap<>();
	...
	// __HPCF
	public final static Map<Float, Map<Integer, Byte>> HighPassCutOffMap = new HashMap<>();
	...
	static {
		...
		Map<Integer, Byte> map3 = new HashMap<>();
		...
		Map<Integer, Byte> map5 = new HashMap<>();
		...
		Map<Integer, Byte> map6 = new HashMap<>();
		...
		Map<Integer, Byte> map7 = new HashMap<>();
		...
		Map<Integer, Byte> map8 = new HashMap<>();
		...
		Map<Integer, Byte> map9 = new HashMap<>();
		...
		Map<Integer, Byte> map10 = new HashMap<>();
		...
		Map<Integer, Byte> map11 = new HashMap<>();
		...
		Map<Integer, Byte> map12 = new HashMap<>();
