...
public class KeyboardController {
	...
	private final Pin[] kpRow = new Pin[] {
	...
	public KeyboardController(boolean print) {
		...
		if (print) {
			...
			String[] map = new String[]{
					PinUtil.findByPin(kpRow[0]).pinNumber() + ":" + "R1",
					PinUtil.findByPin(kpRow[1]).pinNumber() + ":" + "R2",
					PinUtil.findByPin(kpRow[2]).pinNumber() + ":" + "R3",
					PinUtil.findByPin(kpRow[3]).pinNumber() + ":" + "R4",
