...
# SERIAL_PRMS="${SERIAL_PRMS} -Dserial.port=/dev/tty.usbmodem1411"
...
# sudo java ${JAVA_OPTIONS} ${SERIAL_PRMS} -cp ${CP} arduino.ArduinoLoRaClient
java ${JAVA_OPTIONS} ${SERIAL_PRMS} -cp ${CP} arduino.ArduinoLoRaServer
#
