...
public class XMLParserSampleFour {
	...
	private static boolean justUntypedNamedElements = "false".equals(System.getProperty("expand.all"));
	private static final String SCHEMA_LOCATION = System.getProperty("schema.location", "xml" + File.separator + "wireframe.xsd");
