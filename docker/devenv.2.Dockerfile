...
#
# To run on a laptop.
# Basic development environment, Ubuntu or Debian (see above)
#
...
RUN echo "echo ' - Note: VNC password is akeucoucou'" >> $HOME/.bashrc
...
CMD ["vncserver", ":1", "-geometry", "1440x900", "-depth", "24"]
