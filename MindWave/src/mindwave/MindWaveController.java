...
//  cs = (byte)(0xFF - checkSum);
  ...
  private void sendToMindWave(String payload) { sendToMindWave(payload.getBytes(), true); }
...
//      System.out.println("Parsing payload type [" + DumpUtil.lpad(Integer.toHexString(type & 0xFF), 2, "0") + "]");
  ...
  //      System.out.println("Now parsing mess offset " + subMessOffset);
    ...
    public List<Object> getParsed() { return parsed; }
  }
  ...
  public static class BatteryLevel extends OneByteValue { public BatteryLevel(byte[] ba) { super(ba); }}
  public static class PoorSignal extends OneByteValue { public PoorSignal(byte[] ba) { super(ba); }}
  public static class HeartRate extends OneByteValue { public HeartRate(byte[] ba) { super(ba); }}
  public static class Attention extends OneByteValue { public Attention(byte[] ba) { super(ba); }}
  public static class Meditation extends OneByteValue { public Meditation(byte[] ba) { super(ba); }}
  public static class EightBitRaw extends OneByteValue { public EightBitRaw(byte[] ba) { super(ba); }}
  public static class RawMarker extends OneByteValue { public RawMarker(byte[] ba) { super(ba); }}
