...
public class SSD1305 {
	 ...
	 * -------------+------------------------------+----------------+--------=-----------+----
	 */
	public SSD1305(Pin clock, Pin mosi, Pin cs, Pin rst, Pin dc) {
		spiClk = clock;
		spiMosi = mosi;
		spiCs = cs;
		spiRst = rst;
	 ...
	 * @param h     Buffer height (pixels). Default is 32
	 */
	public SSD1305(Pin clock, Pin mosi, Pin cs, Pin rst, Pin dc, int w, int h) {
		spiClk = clock;
		spiMosi = mosi;
		spiCs = cs;
		spiRst = rst;
	 ...
	 * @throws IOException
	 */
	public SSD1305(int i2cAddr) throws I2CFactory.UnsupportedBusNumberException, IOException {
