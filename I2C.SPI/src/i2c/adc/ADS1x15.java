...
public class ADS1x15
{
  ...
  public enum spsADS1115 
  {
    ...
    spsADS1115(int meaning, int value) { this.meaning = meaning; this.value = value; }    
    public int meaning() { return this.meaning; }
  ...
  public enum spsADS1015
  {
    ...
    private final int meaning, value;
    spsADS1015(int meaning, int value) { this.meaning = meaning; this.value = value; }    
    public int meaning() { return this.meaning; }
    public int value() { return this.value; }
  ...
  public enum pgaADS1x15 
  {
    ...
    private final int meaning, value;
    pgaADS1x15(int meaning, int value) { this.meaning = meaning; this.value = value; }    
    public int meaning() { return this.meaning; }
    public int value() { return this.value; }
...
//  System.out.println("Delay:" + delay + " ms:" + ms + ", ns:" + ns);
    try { Thread.sleep(ms, ns); } catch (InterruptedException ie) { ie.printStackTrace(); }
  }
