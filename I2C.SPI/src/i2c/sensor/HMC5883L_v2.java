...
public class HMC5883L_v2 {
	...
	private static float _hmc5883_Gauss_LSB_XY = 1_100.0F;  // Varies with gain
	...
	public HMC5883L_v2() throws I2CFactory.UnsupportedBusNumberException {
		this(HMC5883L_ADDRESS);
	}

	public HMC5883L_v2(int address) throws I2CFactory.UnsupportedBusNumberException {
		try {
			// Get i2c bus
...
//		zOut *= SCALE;
	...
	public static void main(String... args) throws I2CFactory.UnsupportedBusNumberException {
		...
		HMC5883L_v2 sensor = new HMC5883L_v2();
		sensor.init();
