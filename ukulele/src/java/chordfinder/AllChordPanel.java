  ...
  extends JPanel
{
  ...
  private void initTable()
  {
    this.dataModel = new AbstractTableModel()
    {
      ...
      public int getColumnCount() { return 28; }

      public int getRowCount() { return AllChordPanel.this.data.length; }

      public Object getValueAt(int row, int col) { return AllChordPanel.this.data[row][col]; }
