...
public class ChordUtil {
	...
	private static final String DEFAULT_DURATION = "i";
	private static final String FINAL_DURATION = "w";
	...
	public static final int[] findLowestFinger(Chord chord) {
		...
		return new int[]{lowest == Integer.MAX_VALUE ? 0 : lowest, highest};
	}

	public static final String generateMusicString(Chord chord) {
		String pattern = "T240 I[Guitar] ";
		Chord toPlay = chord;
		if (toPlay == null) {
