  ...
  extends JPanel
{
  ...
  private void initTable()
  {
    this.dataModel = new AbstractTableModel()
    {
      ...
      public int getColumnCount() { return TonalRegionChordPanel.NB_COLUMNS; }

      public int getRowCount() { return TonalRegionChordPanel.this.data.length; }

      public Object getValueAt(int row, int col) { return TonalRegionChordPanel.this.data[row][col]; }

      public String getColumnName(int column) { return TonalRegionChordPanel.colName[column]; }
