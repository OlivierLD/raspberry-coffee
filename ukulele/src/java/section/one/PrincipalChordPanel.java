  ...
  extends JPanel
{
  ...
  private void initTable()
  {
    this.dataModel = new AbstractTableModel()
    {
      ...
      public int getColumnCount() { return PrincipalChordPanel.NB_COLUMNS; }

      public int getRowCount() { return PrincipalChordPanel.this.data.length; }

      public Object getValueAt(int row, int col) { return PrincipalChordPanel.this.data[row][col]; }

      public String getColumnName(int column) { return PrincipalChordPanel.colName[column]; }
