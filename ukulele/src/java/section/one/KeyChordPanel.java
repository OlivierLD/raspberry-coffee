  ...
  extends JPanel
{
  ...
  private void initTable()
  {
    this.dataModel = new AbstractTableModel()
    {
      ...
      public int getColumnCount() { return KeyChordPanel.NB_COLUMNS; }

      public int getRowCount() { return KeyChordPanel.this.data.length; }

      public Object getValueAt(int row, int col) { return KeyChordPanel.this.data[row][col]; }

      public String getColumnName(int column) { return KeyChordPanel.colName[column]; }
