  ...
  extends JPanel
{
  ...
  private void initTable()
  {
    this.dataModel = new AbstractTableModel()
    {
      ...
      public int getColumnCount() { return VampChordPanel.NB_COLUMNS; }

      public int getRowCount() { return VampChordPanel.this.data.length; }

      public Object getValueAt(int row, int col) { return VampChordPanel.this.data[row][col]; }

      public String getColumnName(int column) { return VampChordPanel.colName[column]; }
      ...
      public void setValueAt(Object aValue, int row, int column) {
        VampChordPanel.this.data[row][column] = aValue;
