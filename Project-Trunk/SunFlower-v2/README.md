...
## Two flavors
> _**Important Note**_: the celestial data calculation (to obtain the the Sun's coordinates) use the current date as a parameter, which is probably the most important one.
