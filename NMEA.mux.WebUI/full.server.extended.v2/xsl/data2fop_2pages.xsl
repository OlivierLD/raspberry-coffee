...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:block break-after="page"> <!-- background-image="url('bg.jpg')"-->
            ...
            <fo:block margin="0.5in">
              ...
              <fo:block text-align="left" font-family="Arial" font-size="8pt" font-style="italic">
                <xsl:value-of select="$compare-with"/> http://aa.usno.navy.mil/data/docs/celnavtable.php, http://maia.usno.navy.mil/, http://maia.usno.navy.mil/ser7/deltat.data
              </fo:block>
              <fo:block margin="0.2in"/>
              <fo:block text-align="left" font-family="Arial" font-size="8pt" font-style="italic">
                <xsl:value-of select="$SHA-warning"/>
              </fo:block>
    ...
    <fo:block text-align="center" font-family="Courier" font-size="10pt" break-after="page" margin="0.1in">
      ...
      <fo:block margin="0.15in">
        <fo:table> <!-- border="0.5pt solid black"> -->
          <fo:table-column column-width="0.22in"/>   <!-- UT -->
          <fo:table-column column-width="0.60in"/>   <!-- Sun GHA -->
          <fo:table-column column-width="0.45in"/>   <!-- Sun delta GHA -->
          <fo:table-column column-width="0.60in"/>   <!-- Sun SHA -->
          <fo:table-column column-width="0.68in"/>   <!-- Sun Dec -->
          <fo:table-column column-width="0.43in"/>   <!-- Sun delta Dec -->
          <fo:table-column column-width="0.60in"/>   <!-- Moon GHA -->
          <fo:table-column column-width="0.45in"/>   <!-- Moon delta GHA -->
          <fo:table-column column-width="0.60in"/>   <!-- Moon SHA -->
          <fo:table-column column-width="0.68in"/>   <!-- Moon Dec -->
          <fo:table-column column-width="0.43in"/>   <!-- Moon delta Dec -->
          <fo:table-column column-width="0.50in"/>   <!-- Moon hp -->
          <fo:table-column column-width="0.60in"/>   <!-- Aries GHA -->
          <!--fo:table-column column-width="0.45in"/-->   <!-- Aries delta GHA -->
          <fo:table-column column-width="0.22in"/>   <!-- UT -->
          <fo:table-header>
            <fo:table-row>
              ...
              <fo:table-cell number-columns-spanned="5" padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt"><xsl:value-of select="$sun"/>&nbsp;<fo:external-graphic src="url('sun.png')"/></fo:block></fo:table-cell>
              <fo:table-cell number-columns-spanned="6" padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt"><xsl:value-of select="$moon"/>&nbsp;<fo:external-graphic src="url('moon.png')"/></fo:block></fo:table-cell>
          ...
          <fo:table-body font-size="7pt">
            ...
            <fo:table-row>
              ...
              <fo:table-cell number-columns-spanned="1" padding="medium" border="0.5pt solid black">
                <fo:block><fo:inline font-style="italic">
                  <fo:inline font-family="Symbol">d</fo:inline>
            ...
            <fo:table-row>
              ...
              <fo:table-cell number-columns-spanned="2" number-rows-spanned="3" padding="medium" border="0.5pt solid black">
              ...
              <fo:table-cell number-rows-spanned="3" number-columns-spanned="1" padding="medium" border="0.5pt solid black"><fo:block text-align="left" font-family="Arial" font-size="10pt"/></fo:table-cell>
            </fo:table-row>
            <fo:table-row>
      ...
      <fo:block margin="0.15in">
        <fo:table> <!--  border="0.5pt solid black"> -->
          <fo:table-column column-width="0.22in"/>
          <fo:table-column column-width="0.60in"/> <!-- GHA -->
          <fo:table-column column-width="0.60in"/> <!-- SHA -->
          <fo:table-column column-width="0.60in"/> <!-- Dec -->
          <fo:table-column column-width="0.60in"/> <!-- GHA -->
          <fo:table-column column-width="0.60in"/> <!-- SHA -->
          <fo:table-column column-width="0.60in"/> <!-- Dec -->
          <fo:table-column column-width="0.60in"/> <!-- GHA -->
          ...
          <fo:table-header>
            <fo:table-row>
              <fo:table-cell number-rows-spanned="2" padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt">UT</fo:block></fo:table-cell>
              <fo:table-cell number-columns-spanned="3" padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt"><xsl:value-of select="$venus"/>&nbsp;<fo:external-graphic src="url('venus.png')"/>&nbsp;<fo:inline  font-size="6pt">(<fo:inline font-family="Symbol">p</fo:inline>&nbsp;<xsl:value-of select="xsl-util:formatX2(number(./data:data[@hour='1']/data:planets/data:body[@name='Venus']/@hp * 0.016666666))"/>')</fo:inline></fo:block></fo:table-cell>
              <fo:table-cell number-columns-spanned="3" padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt"><xsl:value-of select="$mars"/>&nbsp;<fo:external-graphic src="url('mars.png')"/>&nbsp;<fo:inline  font-size="6pt">(<fo:inline font-family="Symbol">p</fo:inline>&nbsp;<xsl:value-of select="xsl-util:formatX2(number(./data:data[@hour='1']/data:planets/data:body[@name='Mars']/@hp * 0.016666666))"/>')</fo:inline></fo:block></fo:table-cell>
              <fo:table-cell number-columns-spanned="3" padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt"><xsl:value-of select="$jupiter"/>&nbsp;<fo:external-graphic src="url('jupiter.png')"/></fo:block></fo:table-cell>
              <fo:table-cell number-columns-spanned="3" padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt"><xsl:value-of select="$saturn"/>&nbsp;<fo:external-graphic src="url('saturn.png')"/></fo:block></fo:table-cell>
              <fo:table-cell number-rows-spanned="2" padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt">UT</fo:block></fo:table-cell>
            </fo:table-row>
            <fo:table-row>
              <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt"><xsl:value-of select="$gha-moon-planets"/></fo:block></fo:table-cell>
              <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt"><xsl:value-of select="$sha"/></fo:block></fo:table-cell> <!-- TODO Translate -->
              <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt"><xsl:value-of select="$dec"/></fo:block></fo:table-cell>
              <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt"><xsl:value-of select="$gha-moon-planets"/></fo:block></fo:table-cell>
              <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt"><xsl:value-of select="$sha"/></fo:block></fo:table-cell> <!-- TODO Translate -->
              <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-family="Arial" font-size="10pt"><xsl:value-of select="$dec"/></fo:block></fo:table-cell>
              ...
              <xsl:for-each select="./data:data[@hour=0]/data:stars/data:body">
                ...
                <fo:table-row>
                  <fo:table-cell padding="medium" border="0.5pt solid black">
                    ...
                    <xsl:variable name="loc-in-const">
                      <xsl:choose>
                        <xsl:when test="contains(substring-before(./@loc, ' '), 'alpha') or contains(substring-before(./@loc, ' '), 'alfa')">
                          <xsl:value-of select="'a'"/>
                        </xsl:when>
                        <xsl:when test="contains(substring-before(./@loc, ' '), 'beta')">
                          <xsl:value-of select="'b'"/>
                        </xsl:when>
                        <xsl:when test="contains(substring-before(./@loc, ' '), 'gamma')">
                          <xsl:value-of select="'g'"/>
                        </xsl:when>
                        <xsl:when test="contains(substring-before(./@loc, ' '), 'delta')">
                          <xsl:value-of select="'d'"/>
                        </xsl:when>
                        <xsl:when test="contains(substring-before(./@loc, ' '), 'theta')">
                          <xsl:value-of select="'q'"/>
                        </xsl:when>
                        <xsl:when test="contains(substring-before(./@loc, ' '), 'epsilon')">
                          <xsl:value-of select="'e'"/>
                        </xsl:when>
                        <xsl:when test="contains(substring-before(./@loc, ' '), 'zeta')">
                          <xsl:value-of select="'z'"/>
                        </xsl:when>
                        <xsl:when test="contains(substring-before(./@loc, ' '), 'eta')">
                          <xsl:value-of select="'h'"/>
                        </xsl:when>
                        <xsl:when test="contains(substring-before(./@loc, ' '), 'sigma')">
                          <xsl:value-of select="'s'"/>
                        </xsl:when>
                        <xsl:when test="contains(substring-before(./@loc, ' '), 'lambda')">
                    ...
                    <fo:block text-align="left" font-family="Arial" font-size="8pt">&nbsp;<fo:inline font-weight="bold"><xsl:value-of select="./@name"/></fo:inline>
                    <fo:inline font-size="6pt" font-style="italic">,&nbsp;<fo:inline font-family="Symbol"><xsl:value-of select="$loc-in-const"/></fo:inline>&nbsp;<xsl:value-of select="substring-after(./@loc, ' ')"/></fo:inline>
                    </fo:block>
                  </fo:table-cell>
                ...
                <fo:table>
                  ...
                  <fo:table-body>
                    ...
                    <xsl:for-each select="./data:data[@hour=12]/data:rise-set/data:latitude">
                      <!--xsl:sort select="./@val" data-type="number" order="descending"/--> <!-- BUG in the sort, NPE -->
                      <fo:table-row>
  ...
  <xsl:template match="data:data" name="sun-moon-aries">
    ...
    <fo:table-row>
      ...
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="normalize-space(xsl-util:decToSex($data/data:body[@name='Sun']/@GHA, $GEOMUTIL.SWING, $GEOMUTIL.NONE))"/></fo:block></fo:table-cell>
      <fo:table-cell padding="medium" border="0.5pt solid black">
      ...
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="normalize-space(xsl-util:decToSex($data/data:body[@name='Sun']/@SHA, $GEOMUTIL.SWING, $GEOMUTIL.NONE))"/></fo:block></fo:table-cell>
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="normalize-space(xsl-util:decToSex($data/data:body[@name='Sun']/@Dec, $GEOMUTIL.SWING, $GEOMUTIL.NS, $GEOMUTIL.LEADING_SIGN))"/></fo:block></fo:table-cell>
      <fo:table-cell padding="medium" border="0.5pt solid black">
        <fo:block text-align="right" font-size="6pt">
      ...
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="normalize-space(xsl-util:decToSex($data/data:body[@name='Moon']/@GHA, $GEOMUTIL.SWING, $GEOMUTIL.NONE))"/></fo:block></fo:table-cell>
      <fo:table-cell padding="medium" border="0.5pt solid black">
        <fo:block text-align="right" font-size="6pt">
      ...
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="normalize-space(xsl-util:decToSex($data/data:body[@name='Moon']/@SHA, $GEOMUTIL.SWING, $GEOMUTIL.NONE))"/></fo:block></fo:table-cell>
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="normalize-space(xsl-util:decToSex($data/data:body[@name='Moon']/@Dec, $GEOMUTIL.SWING, $GEOMUTIL.NS, $GEOMUTIL.LEADING_SIGN))"/></fo:block></fo:table-cell>
      <fo:table-cell padding="medium" border="0.5pt solid black">
        <fo:block text-align="right" font-size="6pt">
      ...
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="normalize-space(xsl-util:decToSex($data/data:body[@name='Aries']/@GHA, $GEOMUTIL.SWING, $GEOMUTIL.NONE))"/></fo:block></fo:table-cell>
      <!--fo:table-cell padding="medium" border="0.5pt solid black">
	      <fo:block text-align="right" font-size="6pt">
          <xsl:if test="string-length($data/data:body[@name='Aries']/@varGHA) > 0">
            <xsl:value-of select="xsl-util:formatX4($data/data:body[@name='Aries']/@varGHA)"/><xsl:text>&#176;</xsl:text>
          </xsl:if>
	    </fo:block>
	  </fo:table-cell-->
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="center" font-weight="bold"><xsl:value-of select="xsl-util:formatI2($data/@hour)"/></fo:block></fo:table-cell>
  ...
  <xsl:template match="data:data" name="planets">
    ...
    <fo:table-row>
      ...
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="xsl-util:decToSex($data/data:planets/data:body[@name='Venus']/@SHA, $GEOMUTIL.SWING, $GEOMUTIL.NONE)"/></fo:block></fo:table-cell>
      ...
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="xsl-util:decToSex($data/data:planets/data:body[@name='Mars']/@SHA, $GEOMUTIL.SWING, $GEOMUTIL.NONE)"/></fo:block></fo:table-cell>
      ...
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="xsl-util:decToSex($data/data:planets/data:body[@name='Jupiter']/@SHA, $GEOMUTIL.SWING, $GEOMUTIL.NONE)"/></fo:block></fo:table-cell>
      ...
      <fo:table-cell padding="medium" border="0.5pt solid black"><fo:block text-align="right"><xsl:value-of select="xsl-util:decToSex($data/data:planets/data:body[@name='Saturn']/@SHA, $GEOMUTIL.SWING, $GEOMUTIL.NONE)"/></fo:block></fo:table-cell>
