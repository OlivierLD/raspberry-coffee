 ...
 * @returns { lat: L, lng: G }
 */
function deadReckoning(fromL, fromG, heading, dist) {
...
function calculateEastG(nLat, sLat, wLong, canvasW, canvasH) {
