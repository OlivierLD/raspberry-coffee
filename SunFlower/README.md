...
The energy produced by a solar panel is proportional to the sinus of the incidence angle.
In the same light conditions, a panel with an incidence of 90 degrees produces _twice_ the amount of energy generated by the same panel with an incidence of 30 degrees.
