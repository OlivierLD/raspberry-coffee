...
the solar panel is charging) but it is important to have the required output. I use the [PowerBoost 1000 Charger](https://www.adafruit.com/product/2465) from Adafruit.
Then all is good.
