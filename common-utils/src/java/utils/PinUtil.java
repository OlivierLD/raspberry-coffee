...
public class PinUtil {
	...
	public enum GPIOPin {
		...
		GPIO_23("PWM1", 33, -1, 23, RaspiPin.GPIO_23),         /* GND, 34 */
		GPIO_24("PCM_FS/PWM1", 35, -1, 24, RaspiPin.GPIO_24), GPIO_27("GPIO_27", 36, -1, 27, RaspiPin.GPIO_27),
		GPIO_25("GPIO_25", 37, -1, 25, RaspiPin.GPIO_25),     GPIO_28("PCM_DIN", 38, -1, 28, RaspiPin.GPIO_28),
		/* GND, 39 */                                         GPIO_29("PCM_DOUT", 40, -1, 29, RaspiPin.GPIO_29);

		private String pinName; // Pin name
		private int pinNumber;  // Physical
		private int gpio;       // Used by onoff (nodejs)
