...
public class GCTest02 {
    public static void main(String... args) {
        ...
        double gcDistInNM = GreatCircle.getGCDistanceInDegrees(new GreatCirclePoint(37.73, -122.50), new GreatCirclePoint(38.73, -122.50));
        System.out.println("Dist:" + gcDistInNM);

        GreatCirclePoint dr = GreatCircle.dr(new GreatCirclePoint(Math.toRadians(45D), Math.toRadians(-130D)), 55, 270);
