...
//  System.out.println("\t\tReceived character [0x" + Integer.toHexString(b) + "]");
	...
	public static void main(String... args) {
		final AISReaderSample serialReader = new AISReaderSample();
		...
		String serialPortName = System.getProperty("serial.port", "/dev/ttyS0");
		String baudRateStr = System.getProperty("baud.rate", "38400");
