...
public class PinsCustomization {
	...
	public void badOne() {
		...
		try {
			...
			assertTrue(String.format("Unexpected error message [%s]", ex.getMessage()), ex.getMessage().startsWith("keypad.rows should contain 4 elements, comma-separated.")); // ""Please provide both "));
